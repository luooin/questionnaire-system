...
public class CodeAutogenerate {
    ...
    public static void main(String[] args) {
        ...
        dataSourceConfig.setUrl("jdbc:mysql://localhost:3306/questionnaires?useSSL=false&useUnicode=true&characterEncoding=utf-8&serverTimezone=Asia/Shanghai"); // 数据库地址
        ...
        packageConfig.setModuleName("questionnaire_backstage");  // 设置模块名字
        ...
        strategy.setInclude("answer");   // 设置要映射的表名,
        ...
        strategy.setLogicDeleteFieldName("isdelete");  // 设置逻辑删除，参数为逻辑删除的字段名
        // 自动填充策略
